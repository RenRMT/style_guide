...
A single variable/number, a key message or indicator: BAN
...
If the audience is new to the information mapped, they may require a simpler presentation. Likewise, if they are too busy to spend much time reading, they will also need a simple map that summarizes the information. Maps for nonexperts or busy people [...] should have a single message that focuses the attention of the reader.
